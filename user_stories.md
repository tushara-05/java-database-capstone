...
**Title:**
_As an admin, I want to log out of the portal, so that I can protect access to the system when I’m not using it._
**Acceptance Criteria:**
...
**Title:**
_As an admin, I want to add a doctor to the portal, so that the system can include new healthcare providers._
**Acceptance Criteria:**
...
**Title:**
_As an admin, I want to delete a doctor’s profile from the portal, so that outdated or invalid doctor records are removed._
**Acceptance Criteria:**
...
**Acceptance Criteria:**
-	Doctor can see a calendar-style or list-style view of all upcoming appointments.
-	Appointments display patient name, date, time, and appointment type.
-	Appointments are presented in chronological order.
...
-	Marked unavailable slots are saved in the database.
-	Patients cannot book appointments during unavailable times.
-	Calendar clearly distinguishes between available and unavailable slots.
**Priority:** High
**Story Points:** 5
**Notes:**
...
-	Editable fields include specialization, phone number, and description/experience.
-	Updated information is validated before saving.
-	Changes are reflected in the patient-facing doctor directory.
**Priority:** Medium
**Story Points:** 3
**Notes:**
...
**Title:**
_As a doctor, I want to view the patient details for my upcoming appointments, so that I can be prepared._
**Acceptance Criteria:**
-	Doctor can click on an appointment to view details.
-	Details include patient name, contact info, and medical notes (if applicable).
-	Only patient data associated with the doctor is accessible.
-	Data is read-only for compliance and integrity.
**Priority:** High
**Story Points:** 3
**Notes:**
