...
public class PatientService {
    ...
    public ResponseEntity<Map<String, Object>> getPatientAppointment(Long id, String token) {
        ...
        try {
            ...
            // Allow access if it's the patient themselves OR if it's a registered doctor
            boolean isPatientOwner = (patient != null && patient.getId().equals(id));
        ...
        try {
            ...
            if ("past".equalsIgnoreCase(condition)) {
                appointments = appointmentRepository
                        .findByPatient_IdAndAppointmentTimeBeforeOrderByAppointmentTimeDesc(id, now);
            } else if ("future".equalsIgnoreCase(condition)) {
                appointments = appointmentRepository
                        .findByPatient_IdAndAppointmentTimeAfterOrderByAppointmentTimeAsc(id, now);
            } else {
    ...
    public ResponseEntity<Map<String, Object>> filterByDoctorAndCondition(String condition, String name, long patientId) {
        ...
        try {
            ...
            if ("past".equalsIgnoreCase(condition)) {
                appointments = appointmentRepository
                        .filterByDoctorNameAndPatientIdAndTimeBefore(name, patientId, now);
            } else if ("future".equalsIgnoreCase(condition)) {
                appointments = appointmentRepository
                        .filterByDoctorNameAndPatientIdAndTimeAfter(name, patientId, now);
            } else {
                response.put("error", "Invalid condition. Use 'past' or 'future'.");
                return ResponseEntity.badRequest().body(response);
            }
