    ...
    modalContent = `
        ...
        <span class="availabilityLabel">Select Availability:</span>
          <div class="checkbox-group">
              ...
              <label><input type="checkbox" name="availability" value="12:00"> 12:00 PM - 13:00 PM</label>
              <label><input type="checkbox" name="availability" value="13:00"> 13:00 PM - 14:00 PM</label>
              <label><input type="checkbox" name="availability" value="14:00"> 14:00 PM - 15:00 PM</label>
              <label><input type="checkbox" name="availability" value="15:00"> 15:00 PM - 16:00 PM</label>
              <label><input type="checkbox" name="availability" value="16:00"> 16:00 PM - 17:00 PM</label>
          </div>
        </div>
