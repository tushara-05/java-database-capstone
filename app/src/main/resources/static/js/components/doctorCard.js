...
export function createDoctorCard(doctor) {
  ...
  // Doctor specialization - backend uses "speciality", handle both for compatibility
  const specialization = document.createElement("p");
  specialization.textContent = doctor.speciality || doctor.specialization || "General Medicine";
